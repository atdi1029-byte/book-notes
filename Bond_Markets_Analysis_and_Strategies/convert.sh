...
# Python one-liner to convert markdown to HTML
python3 << 'PYEOF'
import re
import html
...
print(f"Created index.html with {len(toc_entries)} sections")
